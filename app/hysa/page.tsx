      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        >
          ...
          <p className="text-slate-300 max-w-3xl">
            A High-Yield Savings Account can earn many times more interest than
            a regular savings account. Use it for your emergency fund and
            short-term goals where safety and quick access matter.
          </p>
        </motion.header>
          ...
          <Card className="bg-slate-900/50 border-white/10">
            <CardHeader className="pb-3">
              ...
              <p className="mt-2 text-sm text-slate-300">
                ...
                . It’s a savings account with a much higher interest rate (what
                your money earns). While regular savings might pay about{" "}
                <span className="font-semibold">0.01%</span> APY, many HYSAs pay{" "}
                <span className="font-semibold">4%+</span> APY. Great for
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-3 rounded-lg border border-white/10 bg-slate-950/50 p-3 text-xs text-slate-300">
                  Example: $2,000 at 0.01% ≈{" "}
                  <span className="font-medium">$0.20</span>/yr. At 4.25% ≈{" "}
                  <span className="font-medium">$85</span>/yr (before taxes).
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-300">
                    <span className="font-semibold">APY</span> = Annual
                    Percentage Yield, the total interest you’ll earn in a year
                    including compounding. Higher APY means more earnings. If
                    the APY changes, your future earnings change too.
                  </p>
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-slate-200">
                  ...
                  <ol className="mt-2 space-y-2 text-sm text-slate-300 list-decimal list-inside">
                    <li>
                      Pick a bank below and click{" "}
                      <span className="font-medium">Sign up</span>.
                    </li>
                    <li>
                      Verify identity (SSN/ITIN) and link your checking account.
                    </li>
                    <li>
                      Transfer your first deposit (many have $0 minimums).
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 grid gap-3 text-sm text-slate-300 md:grid-cols-2">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400/80" />
                      <span className="font-medium">High APY</span> (compare
                      badges on each card).
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400/80" />
                      <span className="font-medium">No monthly fees</span> and
                      low/no minimum deposits.
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400/80" />
                      <span className="font-medium">Fast transfers</span> back
                      to checking.
                    </li>
                  </ul>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400/80" />
                      <span className="font-medium">FDIC/NCUA insurance</span>up
                      to legal limits.
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400/80" />
                      Good app/website UX and clear terms (beware promo APYs
                      that drop later).
                    </li>
                  </ul>
                </div>
